...
- [If CLAUDE.md should be short and focused on preventing mistakes, how does Claude build a rich understanding of project context?](questions/why-keep-claude-md-short.md) — CLAUDE.md corrects default behavior; architecture and goals reach Claude through the codebase, on-demand file references, and specialist subagents
